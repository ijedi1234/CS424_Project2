...
(function() {
  ...
  function useData() {
    ...
    drawPie(App.exoplanetData["BD-06 1339"], "BD-06 1339");
...
function drawPie(starInfo, name) {
	var vis = d3.select("body").append("svg").attr("width", "1200").attr("height", "800") // Added height and width so arc is visible
        var pi = Math.PI;
